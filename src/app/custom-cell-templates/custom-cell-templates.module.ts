...
import { CopyFillHeaderCellTemplateComponent } from "./copy-fill-header-cell-template/copy-fill-header-cell-template.component";
import {
...
@NgModule({
  ...
  providers: [LocalizePipe, MergeSiblingColumnsPipe],
  imports: [
    CommonModule,
    DxDataGridModule,
    DxTextBoxModule,
