...
import { DxPopupComponent, DxSelectBoxComponent, DxSwitchComponent } from "devextreme-angular";
...
export class DuplicationPopupComponent implements OnInit {
  ...
  @ViewChild("copyEntrepsContactsInput") public copyEntrepsContactsInput: DxSwitchComponent;
  ...
  public prompt() {
    ...
    return this.done.pipe(
      concatMapTo(defer(() => this.clientsService.duplicate(
        new Set(["id"]),
        this.client.id,
