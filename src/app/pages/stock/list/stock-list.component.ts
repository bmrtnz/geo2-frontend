...
export class StockListComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.stockArticlesAge =
            this.stockArticlesAgeService.getFetchDatasource();
        ...
        this.calibresMarquages =
            this.stockArticlesAgeService.getFilterDatasource(
    ...
    onCustomFilterChange(items: any[], selector: string) {
        items.length
            ? (this.stockArticlesAgeService.customVariables[selector] =
                  items.map((value) => (delete value.__typename, value)))
