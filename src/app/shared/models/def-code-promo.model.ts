...
export class DefCodePromo extends Model {
    @Field({ asKey: true, model: import("./code-promo.model") }) public codePromo: CodePromo;
    @Field() public numeroTri: number;
    @Field({ asKey: true, model: import("./espece.model") }) public espece: Espece;
    @Field({ asKey: true, model: import("./variete.model") }) public variete: Variete;
