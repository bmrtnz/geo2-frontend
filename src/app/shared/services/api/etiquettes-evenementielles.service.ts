...
export class EtiquettesEvenementiellesService
  extends ApiService
  implements APIRead
{
      ...
      store: this.createCustomStore({
        ...
        load: (options: LoadOptions) =>
          new Promise(async (resolve) => {
            ...
            type Response = {
              allEtiquetteEvenementielle: RelayPage<EtiquetteEvenementielle>;
            };
            ...
            this.listenQuery<Response>(query, { variables }, (res) => {
              if (res.data && res.data.allEtiquetteEvenementielle)
                resolve(
                  this.asInstancedListCount(res.data.allEtiquetteEvenementielle)
                );
            });
          }),
        byKey: (key) =>
          new Promise(async (resolve) => {
            ...
            type Response = {
              etiquetteEvenementielle: EtiquetteEvenementielle;
            };
            ...
            this.listenQuery<Response>(query, { variables }, (res) => {
              if (res.data && res.data.etiquetteEvenementielle)
                resolve(
                  new EtiquetteEvenementielle(res.data.etiquetteEvenementielle)
                );
            });
          }),
      }),
